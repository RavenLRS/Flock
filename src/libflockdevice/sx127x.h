...
typedef enum
{
    SX127X_CLKOUT_DIV_1 = 0,
    SX127X_CLKOUT_DIV_2 = 1,
    SX127X_CLKOUT_DIV_4 = 2,
    SX127X_CLKOUT_DIV_8 = 3,
    SX127X_CLKOUT_DIV_16 = 4,
    SX127X_CLKOUT_DIV_32 = 5,
    SX127X_CLKOUT_DIV_RC = 6,
    SX127X_CLKOUT_DIV_OFF = 7,
} sx127x_clkout_div_e;
...
{
    sx127x_output_type_e output_type;
    struct
    {
